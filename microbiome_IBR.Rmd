...
#setup
##set working directory from BU desktop
```{r}
setwd("C:/Users/scvogel/Dropbox/BASELab/DMMProject/Data/Analyses")
```

##set working directory from laptop
```{r}
setwd("/Users/sarahvogel/Library/CloudStorage/Dropbox/BASELab/DMMProject/Data/Analyses")
```
...
##load in data files
```{r}
df <- read.csv("metadata_all_bf.csv")
df$X <- NULL
```
...
LV30_spec_2wk <- Maaslin2(
  ...
  output = "/Users/sarahvogel/Library/CloudStorage/Dropbox/BASELab/DMMProject/Data/Analyses/DA/2weeks/species",
  min_abundance = 0,
  min_prevalence = 0.5, 
...
LV30_genus_2week <- Maaslin2(
  ...
  input_metadata = "metadata_all_LV.tsv",
  output = "/Users/sarahvogel/Library/CloudStorage/Dropbox/BASELab/DMMProject/Data/Analyses/DA/2weeks/Genus",
  min_abundance = 0,
  min_prevalence = 0.5,
  max_significance = 0.25, 
  analysis_method = "lm", #default
...
LV30_paths_2week <- Maaslin2(
  ...
  input_metadata = "metadata_all_LV.tsv",
  output = "/Users/sarahvogel/Library/CloudStorage/Dropbox/BASELab/DMMProject/Data/Analyses/DA/2weeks/Path",
  min_abundance = 0,
  min_prevalence = 0.5,
  max_significance = 0.25, 
  analysis_method = "lm", #default
...
LV30_spec_18mo <- Maaslin2(
  ...
  input_metadata = "metadata_all_LV.tsv",
  output = "/Users/sarahvogel/Library/CloudStorage/Dropbox/BASELab/DMMProject/Data/Analyses/DA/18mo/species",
  min_abundance = 0,
  min_prevalence = 0.5, 
  max_significance = 0.25, 
  analysis_method = "lm", #default
...
LV30_genus_18mo <- Maaslin2(
  ...
  input_metadata = "metadata_all_LV.tsv",
  output = "/Users/sarahvogel/Library/CloudStorage/Dropbox/BASELab/DMMProject/Data/Analyses/DA/18mo/Genus",
  min_abundance = 0,
  min_prevalence = 0.5, 
  max_significance = 0.25, 
  analysis_method = "lm", #default
...
LV30_path_18mo <- Maaslin2(
  ...
  input_metadata = "metadata_all_LV.tsv",
  output = "/Users/sarahvogel/Library/CloudStorage/Dropbox/BASELab/DMMProject/Data/Analyses/DA/18mo/Paths",
  min_abundance = 0,
  min_prevalence = 0.5, 
  max_significance = 0.25, 
  analysis_method = "lm", #default
